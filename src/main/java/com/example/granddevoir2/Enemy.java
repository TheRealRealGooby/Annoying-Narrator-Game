...
public class Enemy extends Character{
    ...
    // Generates random item that enemy drops when defeated
    // Return new GatherableObject with a random quantity, quality, and type
    ...
    // Implement logic to abstract methods (similar to Player.java)
    @Override
    int damage() {
        return this.attack;
    }
